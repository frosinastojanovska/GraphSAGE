...
class SampleAndAggregate(GeneralizedModel):
    ...
    def __init__(self, placeholders, features, adj, degrees,
        ...
        Args:
            ...
            - layer_infos: List of SAGEInfo named tuples that describe the parameters of all
    ...
    def build(self):
        ...
        super(SampleAndAggregate, self).build()
    ...
    def _accuracy(self):
        ...
        indices_of_ranks = tf.py_func(np.argsort, [-self.aff_all], tf.int64)
        # _, self.ranks = tf.nn.top_k(-indices_of_ranks, k=size)
        self.ranks = tf.py_func(np.argsort, [indices_of_ranks], tf.int64)
